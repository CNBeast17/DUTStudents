...

{
    ...
    public class BlobStoragerepository: IBlobStorageRepository
    {
        ...
        private string containerNamex = "studentcontainer";
        private string downloadPath = @"C:\\";
    
        public BlobStoragerepository()
        {
            string accontNamex = "eliteazurestorageaccount";
            string keyx = "uCMucNIYlHXU6qmtx4t1GWWLFQgBzTQEdQ0utDVUf/+3C2cIZUHvzTDVHtyqwVVPg+Mev8BjeHG25khS1hz6EA==";
